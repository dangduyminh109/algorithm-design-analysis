...
export default function TheoryPage() {
  ...
  const PropertyBadge = ({ value, trueLabel, falseLabel }: { value: boolean; trueLabel: string; falseLabel: string }) => (
    <div className={`flex items-center gap-1 px-3 py-1 rounded-full text-sm font-semibold border-2 ${
      value 
        ...
        >
          ...
          <div className="relative mb-4">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-lg bg-white text-gray-800 font-medium focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
            {searchQuery && (
              <button
            ...
            <div className="mt-4 p-3 bg-blue-100 border border-blue-200 rounded-lg flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`text-sm font-bold px-4 py-1 rounded-lg transition-colors ${
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gradient-to-r from-gray-100 to-gray-50">
                <tr>
                  <th className="text-left py-4 px-6 font-bold text-gray-800 w-52">Thuật Toán</th>
                  <th className="text-center py-4 px-4 font-bold text-gray-800 w-28">Best</th>
                  <th className="text-center py-4 px-4 font-bold text-gray-800 w-28">Average</th>
                  <th className="text-center py-4 px-4 font-bold text-gray-800 w-28">Worst</th>
                  <th className="text-center py-4 px-4 font-bold text-gray-800 w-24">Space</th>
                  <th className="text-center py-4 px-4 font-bold text-gray-800 w-20">Stable</th>
                  <th className="text-center py-4 px-4 font-bold text-gray-800 w-24">In-Place</th>
                  <th className="text-center py-4 px-6 font-bold text-gray-800 w-44">Actions</th>
                </tr>
              </thead>
              <tbody>
                {filteredTheories.map((theory, idx) => (
                  ...
                  >
                    <td className="py-4 px-6">
                      <div>
                        <div className="font-bold text-lg text-gray-800">{theory.name}</div>
                    ...
                    <td className="text-center py-4 px-6">
                      <div className="inline-block bg-green-200 border border-green-300 px-2 py-1 rounded font-semibold">
                        <LaTeX formula={theory.timeComplexity.best.formula} inline />
                      </div>
                    </td>
                    <td className="text-center py-4 px-6">
                      <div className="inline-block bg-yellow-200 border border-yellow-300 px-2 py-1 rounded font-semibold">
                        <LaTeX formula={theory.timeComplexity.average.formula} inline />
                      </div>
                    </td>
                    <td className="text-center py-4 px-6">
                      <div className="inline-block bg-red-200 border border-red-300 px-2 py-1 rounded font-semibold">
                        <LaTeX formula={theory.timeComplexity.worst.formula} inline />
                      </div>
                    </td>
                    <td className="text-center py-4 px-6">
                      <div className="inline-block bg-blue-200 border border-blue-300 px-2 py-1 rounded font-semibold">
                    ...
                    <td className="text-center py-4 px-6">
                      {theory.properties.stable ? (
                        ...
                        <XCircle className="w-5 h-5 text-red-700 mx-auto" />
                      )}
                    </td>
                    <td className="text-center py-4 px-6">
                    ...
                    <td className="py-4 px-6">
                      <div className="flex gap-2 justify-center items-center">
                        <button
                          ...
                          className="w-20 px-3 py-1.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-bold whitespace-nowrap shadow-md"
                        >
                          Chi tiết
                        </button>
                        <button
                          onClick={() => toggleComparison(theory.id)}
                          className={`w-20 px-3 py-1.5 rounded-lg transition-colors text-sm font-bold whitespace-nowrap shadow-md ${
        ...
        {selectedTheory && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-xl shadow-2xl border-2 border-gray-300 max-w-4xl w-full max-h-[90vh] overflow-y-auto"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Modal Header */}
              <div className="sticky top-0 bg-gradient-to-r from-blue-50 to-cyan-50 border-b-2 border-gray-300 p-6 flex items-center justify-between z-10">
                <h2 className="text-2xl font-bold text-gray-800">{selectedTheory.name}</h2>
                <button
                  onClick={() => setSelectedTheory(null)}
                  className="text-gray-500 hover:text-gray-800 hover:bg-gray-200 p-2 rounded-lg transition-colors"
                >
                  <X className="w-6 h-6" />
                </button>
              </div>
              ...
              <div className="p-6 space-y-6">
                {/* Overview */}
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3">Tổng Quan</h3>
                ...
                {/* Time Complexity */}
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3">Time Complexity</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {(['best', 'average', 'worst'] as const).map((case_) => (
                      <div key={case_} className="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-300 p-4 rounded-lg shadow-md">
                        <div className="text-sm text-gray-700 font-bold mb-2 uppercase">
                          {case_}
                        </div>
                ...
                {/* Properties */}
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3">Thuộc Tính</h3>
                ...
                {/* How It Works */}
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3">Cách Hoạt Động</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-green-50 border-2 border-green-200 p-4 rounded-lg">
                    <h3 className="text-xl font-bold mb-3 text-green-800">Ưu Điểm</h3>
                  ...
                  <div className="bg-red-50 border-2 border-red-200 p-4 rounded-lg">
                    <h3 className="text-xl font-bold mb-3 text-red-800">Nhược Điểm</h3>
                    <ul className="space-y-2">
                ...
                {/* Applications */}
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-3">Ứng Dụng Thực Tế</h3>
                  <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {selectedTheory.practical.realWorldApplications.map((app, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        <Zap className="w-4 h-4 text-blue-700 flex-shrink-0 mt-1" />
                    ...
                    <div className="flex justify-between items-start mb-2">
                      ...
                      {selectedTheory.history.wikipediaUrl && (
                        <a 
                          ...
                          className="flex items-center gap-1 text-blue-700 hover:text-blue-900 hover:underline text-sm font-semibold"
                        >
                          <span>Wikipedia</span>
        ...
        {showComparison && selectedForComparison.size >= 2 && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.9, opacity: 0 }}
              className="bg-white rounded-xl shadow-2xl border-2 border-gray-300 max-w-7xl w-full max-h-[90vh] overflow-y-auto"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Modal Header */}
              <div className="sticky top-0 bg-gradient-to-r from-blue-50 to-cyan-50 backdrop-blur-sm border-b-2 border-gray-300 p-6 flex items-center justify-between z-10 shadow-md">
                <div>
                    ...
                    <div className="space-y-6">
                          ...
                          >
                            ...
                            <div className="mt-4 pt-4 border-t-2 border-gray-300">
                              <div className="flex items-center justify-between">
                                <span className="text-xs uppercase tracking-wider text-gray-700 font-bold">Difficulty</span>
                                <span className={`text-sm font-bold px-3 py-1 rounded border-2 ${
                                  theory.difficulty === 'Dễ' ? 'bg-green-200 text-green-800 border-green-400' :
                                  theory.difficulty === 'Trung Bình' ? 'bg-yellow-200 text-yellow-800 border-yellow-400' :
                                  'bg-red-200 text-red-800 border-red-400'
                                }`}>
                                  {theory.difficulty}
                                </span>
                      ...
                      >
                        ...
                        <div className="overflow-x-auto">
                          <table className="w-full">
                            <thead className="bg-gradient-to-r from-gray-100 to-gray-50">
                              <tr>
                                <th className="text-left py-3 px-4 font-bold text-sm text-gray-800">Metric</th>
                                {comparisonTheories.map((theory, idx) => (
                                  <th key={theory.id} className="text-center py-3 px-4">
                                    <span className={`inline-flex items-center gap-1 text-sm font-bold bg-gradient-to-r ${algorithmColors[idx]} bg-clip-text text-transparent`}>
                                      {theory.name}
                                    </span>
                                  </th>
                                ))}
                            ...
                            <tbody className="divide-y divide-gray-300">
                              <tr className="hover:bg-blue-50 transition-colors">
                                <td className="py-3 px-4 font-bold text-sm text-gray-800">Best Case</td>
                              ...
                              <tr className="hover:bg-blue-50 transition-colors">
                                <td className="py-3 px-4 font-bold text-sm text-gray-800">Average Case</td>
                                {comparisonTheories.map((theory) => (
                                  <td key={theory.id} className="text-center py-3 px-4">
                                    <div className={`inline-block px-3 py-1.5 rounded-lg border-2 font-semibold ${getComplexityColor(theory.timeComplexity.average.bigO)}`}>
                                      <LaTeX formula={theory.timeComplexity.average.formula} inline />
                                    </div>
                                  </td>
                                ))}
                              ...
                              <tr className="hover:bg-blue-50 transition-colors">
                                <td className="py-3 px-4 font-bold text-sm text-gray-800">Worst Case</td>
                                {comparisonTheories.map((theory) => (
                                  <td key={theory.id} className="text-center py-3 px-4">
                                    <div className={`inline-block px-3 py-1.5 rounded-lg border-2 font-semibold ${getComplexityColor(theory.timeComplexity.worst.bigO)}`}>
                                      <LaTeX formula={theory.timeComplexity.worst.formula} inline />
                                    </div>
                                  </td>
                                ))}
                              ...
                              <tr className="hover:bg-blue-50 transition-colors">
                                <td className="py-3 px-4 font-bold text-sm text-gray-800">Space</td>
                                {comparisonTheories.map((theory) => (
                                  <td key={theory.id} className="text-center py-3 px-4">
                                    <div className={`inline-block px-3 py-1.5 rounded-lg border-2 font-semibold ${getComplexityColor(theory.spaceComplexity.auxiliary.bigO)}`}>
                                      <LaTeX formula={theory.spaceComplexity.auxiliary.formula} inline />
                                    </div>
                                  </td>
                                ))}
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                          {['stable', 'inPlace', 'adaptive', 'recursive', 'comparison'].map((prop) => (
                            <div key={prop} className="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-300 p-4 rounded-lg">
                              <div className="text-sm font-bold mb-3 text-center capitalize text-gray-800">
                              ...
                              <div className="space-y-2">
                                {comparisonTheories.map((theory, idx) => {
                                  ...
                                  return (
                                    <div key={theory.id} className="flex items-center justify-between gap-2 p-2 bg-white border border-gray-300 rounded">
                                      <span className={`text-xs font-bold bg-gradient-to-r ${algorithmColors[idx]} bg-clip-text text-transparent`}>
                                        {theory.name.split(' ')[0]}
                                      </span>
                                      {value ? (
                      ...
                      >
                        ...
                        <div className="space-y-5">
                          {(['best', 'average', 'worst'] as const).map((case_) => (
                            <div key={case_}>
                              <div className="text-base font-bold text-gray-800 mb-3 uppercase tracking-wide">
                                {case_ === 'best' ? 'Best Case' : case_ === 'average' ? 'Average Case' : 'Worst Case'}
                              </div>
                              <div className="grid gap-4" style={{ gridTemplateColumns: `repeat(${comparisonTheories.length}, 1fr)` }}>
                                {comparisonTheories.map((theory, idx) => (
                                  <div key={theory.id} className="bg-gradient-to-br from-gray-50 to-gray-100 p-5 rounded-lg border-2 border-gray-300 hover:border-blue-400 transition-colors shadow-md">
                      ...
                      <div className="grid gap-6" style={{ gridTemplateColumns: `repeat(${comparisonTheories.length}, 1fr)` }}>
                        {comparisonTheories.map((theory, idx) => (
                          ...
                          >
                            <div className="bg-gradient-to-r from-gray-100 to-gray-50 p-4 border-b-2 border-gray-300">
                              ...
                              <ul className="space-y-2.5">
                                {theory.tradeoffs.cons.map((con, conIdx) => (
                                  <li key={conIdx} className="text-sm flex items-start gap-2 leading-relaxed">
                                    <span className="text-red-700 flex-shrink-0 mt-1">•</span>
                      ...
                      >
                        ...
                        <div className="grid gap-4" style={{ gridTemplateColumns: `repeat(${comparisonTheories.length}, 1fr)` }}>
                          {comparisonTheories.map((theory, idx) => (
                            <div key={theory.id} className="bg-gradient-to-br from-gray-50 to-gray-100 p-5 rounded-lg border-2 border-gray-300 hover:border-amber-400 transition-colors shadow-md">
                      ...
                      <motion.div
                        ...
                        className="bg-blue-100 border-2 border-blue-300 rounded-xl shadow-lg p-6"
                      >
                        <h3 className="text-xl font-bold mb-3 flex items-center gap-2 text-blue-800">
